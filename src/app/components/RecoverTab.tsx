...
import { RefreshCw, CheckCircle, Copy, Mail, Send, BookOpen } from 'lucide-react'
              ...
              <div key={acc.id} className="bg-slate-800/40 border border-slate-700 rounded-2xl overflow-hidden">
                ...
                {openPlaybook === acc.id && (
                  <div className="border-t border-slate-700/50 p-4 space-y-4">
                    {/* Score reasons */}
                    <div>
                      <p className="text-xs text-slate-500 font-semibold mb-2">Why this account is scored high</p>
                    ...
                    {/* Email sequence */}
                    <div>
                      <p className="text-xs text-slate-500 font-semibold mb-3">3-email reengagement sequence</p>
                      <div className="space-y-3">
