...
export default function AccelerateTab() {
  ...
  // Stalling first, then At Risk, On Track, Accelerating
              ...
              return (
                <div key={deal.id} className={`border ${st.border} ${st.bg} rounded-2xl overflow-hidden`}>
                  <div className="p-4">
                    ...
                    <div className={`mt-3 p-3 rounded-xl border ${deal.status==='Accelerating'||deal.status==='On Track'?'bg-teal-500/5 border-teal-500/20':'bg-red-500/5 border-red-500/20'}`}>
